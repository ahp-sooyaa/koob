	...
	<div class="flex justify-end mt-auto">
		...
		>
			...
			<template #content>
				<div
					@click="deliveryAddressStore.editAddress(index)"
					class="w-full px-4 py-2 text-left text-sm leading-5 text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition duration-150 ease-in-out flex gap-1.5 items-center"
				>
					<svg
						xmlns="http://www.w3.org/2000/svg"
						fill="none"
				...
				<div
					@click="deleteAddress()"
					class="w-full px-4 py-2 text-left text-sm leading-5 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition duration-150 ease-in-out flex gap-1.5 items-center text-red-400"
				>
					<svg
						xmlns="http://www.w3.org/2000/svg"
						fill="none"
