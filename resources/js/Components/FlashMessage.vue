<template>
  <div>
    <div
      ...
      class="-translate-x-1/2 bg-green-500 fixed flex items-center justify-between left-1/2 max-w-3xl mb-8 mt-8 mx-auto rounded space-x-5 top-0 transform z-50"
    >
