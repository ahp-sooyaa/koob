<template>
    <div v-if="show" class="bg-gray-100 bottom-0 fixed flex items-center left-0 right-0 top-0">
        <div class="text-center lg:w-2/3 w-full mx-auto mt-8 overflow-auto">
            <h2
...
<script>
    export default {
        ...
        created() {
            window.events.on('thankyou', data => {
