<template>
	...
	<div class="mt-10 mx-auto max-w-7xl">
		<div class="grid grid-cols-3 gap-x-10">
			<div class="bg-white p-5 rounded-xl shadow relative overflow-hidden">
				<!-- <svg
					class="fill-current text-gray-700 absolute -right-3 w-20 -top-3 opacity-20"
				...
				<div class="h-8 absolute bottom-0 inset-x-0 rounded-b-xl">
					<Chart
						type="line"
			...
			<div class="bg-white p-5 rounded-xl shadow relative">
				...
				<div class="h-8 absolute bottom-0 inset-x-0 rounded-b-xl overflow-hidden">
					<Chart
						type="line"
						:labels="[0,1,2,3,4,5,6]"
						:datasets="[
			...
			<div class="bg-white p-5 rounded-xl shadow space-y-5 relative">
				<!-- <svg
					class="h-10 w-10 fill-current text-gray-700"
					xmlns="http://www.w3.org/2000/svg"
					viewBox="0 0 20 20"
		...
		<div class="flex space-x-10 mt-10">
			<div class="w-1/2 h-98 bg-white p-5 rounded-xl shadow">
